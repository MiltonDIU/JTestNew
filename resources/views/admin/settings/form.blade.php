...
<div class="form-group {{ $errors->has('test_date') ? 'has-error' : ''}}">
    {!! Form::label('test_date', 'J Test Dates', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-8">
        {!! Form::textarea('test_date', null, ['id'=>'test_date','class' => 'form-control','rows' => '5']) !!}
...
@push('scripts')
    ...
    <script>
        $('#textarea,#textarea2,#admit_message,#test_date').ckeditor({
            language:'es',
            height :200,
